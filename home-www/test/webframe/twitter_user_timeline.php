...
<?
	...
	$user_timeline = $twitter->get("statuses/user_timeline", ["screen_name" => "webframe_io", "include_rts" => true, "count" => 101]);
	//$user_timeline = $twitter->get("statuses/user_timeline", ["screen_name" => "moonriver365", "include_rts" => false, "max_id" => "1184357959926550528"]);
